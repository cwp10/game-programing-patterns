...
namespace Test
{
    public class Drone : MonoBehaviour
    {
        ...
        private Drone _target = null;
        private DroneState _currentState = DroneState.Wander;
        ...
        private bool IsPathBlocked()
        {
            ...
            var hitSomething = Physics.RaycastAll(ray, _rayDistance, layerMask_);
